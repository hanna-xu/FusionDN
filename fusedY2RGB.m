...
folder1='far_near\test_imgs\far';
folder2='far_near\test_imgs\near';
...
L=length(filepath1);
for pic=1:20
    img1=imread(strcat(folder1,'\',num2str(pic),'.jpg'));
    img2=imread(strcat(folder2,'\',num2str(pic),'.jpg'));
    imgf_y=double(imread(strcat(folderf,'\',num2str(pic),'.jpg')));
    ...
    savepath=strcat(folderf,'\rgb\',num2str(pic),'.jpg');
