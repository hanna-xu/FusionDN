...
def main():
	...
	file_name1=glob(path1+'/*jpg')
	file_name2=glob(path2+'/*jpg')


	for i in range(10):
		file_name1 = path1 + '/' + str(i + 11) + '.jpg'
		file_name2 = path2 + '/' + str(i + 11) + '.jpg'
		...
		with tf.Graph().as_default(), tf.Session() as sess:
			...
			model_save_path = MODEL_SAVE_PATH + str(model_num) + '/' + str(model_num) + '.ckpt'
